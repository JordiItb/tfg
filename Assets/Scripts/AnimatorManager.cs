...
public class AnimatorManager : MonoBehaviour
{
    ...
    private void Awake(){
        ...
        horizontal = Animator.StringToHash("Horizontal"); //Gets horizontal value from animator.
        vertical = Animator.StringToHash("Vertical"); //Gets vertical value from animator.
