...
public class GrassPainterEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        grassPainter.brushSize = EditorGUILayout.Slider("Brush Size", grassPainter.brushSize, 0.1f, 50f);
        grassPainter.density = EditorGUILayout.Slider("Density", grassPainter.density, 0.1f, 50f);
